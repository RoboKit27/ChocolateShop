...
namespace ChocolateShop.DAL.Queries
{
    public static class OrderQueries
    {
        ...
        public const string GetOrderClientQuery = "select C.\"Id\",C.\"Name\",C.\"Phone\",C.\"Gmail\" from \"Order\" as O join \"Client\" as C on C.\"Id\"=O.\"ClientId\" where O.\"Id\"=@Id";
        public const string GetOrderChocolatesQuery = "select \"ChocolateId\" from \"Order_Chocolate\" where \"OrderId\"=@Id";
